...
<Warning>
  Never commit your `.env` file or expose your bot token. Always use environment variables for sensitive information.
</Warning>
...
- Can't respond to queries

Choose the webhook approach if:
- You only need notifications
- You don't want to manage a server
- You need a quick solution
- Your team doesn't need interactive features

Choose the bot approach if:
- You need interactive commands
- You want complete control
- You can manage hosting
- Your team needs advanced features
