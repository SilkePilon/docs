...
If you need test data or want to access a previous version of the Jotihunt API, you can use the Internet Archive's Wayback Machine API. This is particularly useful for development and testing without affecting production data.
<Note>
Dont want to manlualy find an working URL? No problem! The endpoint are filterd and will contain data that can be used for testing.
  <Accordion title="Automatically find the best URL">
    <Check>Current best url to use: <code>https://</code> as of <code>5-5-2025</code></Check>
    <Check>Current best url to use: <code>https://</code> as of <code>5-5-2025</code></Check>
    <Check>Current best url to use: <code>https://</code> as of <code>5-5-2025</code></Check>
  </Accordion>
</Note>
